...
We would love for you to contribute to the ConnectomeeUtilities project and help make it better than it is today.
...
[github]: https://github.com/BlueBrain/ConnectomeUtilities

# Development Environment

Connectome utilities requires python 3.8 or above.
Dependencies are declared in the [setup.py](setup.py)
